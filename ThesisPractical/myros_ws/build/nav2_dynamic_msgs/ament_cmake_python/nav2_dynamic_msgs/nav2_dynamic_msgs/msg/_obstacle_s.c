...
bool nav2_dynamic_msgs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_dynamic_msgs.msg._obstacle.Obstacle", full_classname_dest, 40) == 0);
  }
  nav2_dynamic_msgs__msg__Obstacle * ros_message = _ros_message;
  {  // uuid
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_dynamic_msgs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Obstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_dynamic_msgs.msg._obstacle");
  ...
  nav2_dynamic_msgs__msg__Obstacle * ros_message = (nav2_dynamic_msgs__msg__Obstacle *)raw_ros_message;
  {  // uuid
    PyObject * field = NULL;
