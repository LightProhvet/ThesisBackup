...
#include "nav2_dynamic_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_dynamic_msgs::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_dynamic_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_dynamic_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_nav2_dynamic_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<nav2_dynamic_msgs::msg::Obstacle>()
{
  return &nav2_dynamic_msgs::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
