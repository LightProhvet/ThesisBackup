...
static const _Encoders_type_support_symbol_names_t _Encoders_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_ros2_msgs, msg, Encoders)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_ros2_msgs, msg, Encoders)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_ros2_msgs, msg, Encoders)() {
  return &::robot_ros2_msgs::msg::rosidl_typesupport_c::Encoders_message_type_support_handle;
}
