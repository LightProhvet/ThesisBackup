...
#include "robot_ros2_msgs/msg/detail/tag__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_ros2_msgs::msg::Tag & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_ros2_msgs::msg::Tag & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_ros2_msgs::msg::Tag;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_ros2_msgs::msg::Tag *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_ros2_msgs::msg::Tag *>(
    untyped_ros_message);
...
{
  return &robot_ros2_msgs::msg::typesupport_fastrtps_cpp::_Tag__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_ros2_msgs, msg, Tag)() {
  return &robot_ros2_msgs::msg::typesupport_fastrtps_cpp::_Tag__handle;
}
