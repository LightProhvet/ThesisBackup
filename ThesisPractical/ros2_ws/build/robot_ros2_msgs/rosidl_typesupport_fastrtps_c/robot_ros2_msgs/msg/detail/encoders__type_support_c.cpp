...
#include "robot_ros2_msgs/msg/detail/encoders__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_robot_ros2_msgs
...
using _Encoders__ros_msg_type = robot_ros2_msgs__msg__Encoders;
...
size_t get_serialized_size_robot_ros2_msgs__msg__Encoders(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Encoders__ros_msg_type * ros_message = static_cast<const _Encoders__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Encoders__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_ros2_msgs__msg__Encoders(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_ros2_msgs
size_t max_serialized_size_robot_ros2_msgs__msg__Encoders(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_ros2_msgs__msg__Encoders;
    is_plain =
      (
...
static size_t _Encoders__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_ros2_msgs__msg__Encoders(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_ros2_msgs, msg, Encoders)() {
