...
static const _IntList_type_support_symbol_names_t _IntList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_ros2_msgs, msg, IntList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_ros2_msgs, msg, IntList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_ros2_msgs, msg, IntList)() {
  return &::robot_ros2_msgs::msg::rosidl_typesupport_c::IntList_message_type_support_handle;
}
