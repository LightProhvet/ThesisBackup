...
#include "bond/msg/detail/constants__rosidl_typesupport_fastrtps_c.h"
...
using _Constants__ros_msg_type = bond__msg__Constants;
...
size_t get_serialized_size_bond__msg__Constants(
  const void * untyped_ros_message,
...
static uint32_t _Constants__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bond__msg__Constants(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bond
size_t max_serialized_size_bond__msg__Constants(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bond__msg__Constants;
    is_plain =
      (
...
static size_t _Constants__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_bond__msg__Constants(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bond, msg, Constants)() {
