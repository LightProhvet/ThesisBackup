...
#include "bond/msg/detail/constants__type_support.h"
...
static const _Constants_type_support_symbol_names_t _Constants_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bond, msg, Constants)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bond, msg, Constants)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bond, msg, Constants)() {
  return &::bond::msg::rosidl_typesupport_c::Constants_message_type_support_handle;
}
