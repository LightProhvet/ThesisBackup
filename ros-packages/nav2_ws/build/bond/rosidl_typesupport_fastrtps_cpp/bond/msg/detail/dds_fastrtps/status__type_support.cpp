...
#include "bond/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bond
cdr_serialize(
  const bond::msg::Status & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bond::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bond::msg::Status *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_bond
const rosidl_message_type_support_t *
get_message_type_support_handle<bond::msg::Status>()
{
  return &bond::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bond, msg, Status)() {
  return &bond::msg::typesupport_fastrtps_cpp::_Status__handle;
}
