...
#include "bond/msg/detail/constants__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const bond::msg::Constants & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bond::msg::Constants & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bond::msg::Constants;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bond::msg::Constants *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bond::msg::Constants *>(
    untyped_ros_message);
...
{
  return &bond::msg::typesupport_fastrtps_cpp::_Constants__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bond, msg, Constants)() {
  return &bond::msg::typesupport_fastrtps_cpp::_Constants__handle;
}
